...
export default class BlogForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      content: "",
      featured_image: "",
      apiUrl: "https://gdfelt.devcamp.space/portfolio/portfolio_blogs",
      apiAction: "POST"
  ...
  deleteImage(imageType) {
    axios.delete(
        `https://gdfelt.devcamp.space/portfolio/delete-portfolio-blog-image/${this.props.blog.id}?image_type=${imageType}`,
  ...
  componentWillMount() {
    if (this.props.editMode) {
      this.setState({
        ...
        apiUrl: `https://gdfelt.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
        apiAction: "PATCH"
      })
    }
  }
